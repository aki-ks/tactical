 ...
 */
public class PrimitiveCastStatement implements Statement {
    /**
    ...
    public PrimitiveCastStatement(PrimitiveType fromType, PrimitiveType toType, Register fromRegister, Register toRegister) {
