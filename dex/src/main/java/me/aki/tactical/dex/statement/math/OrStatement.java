...
/**
 * Calculate the bitwise <tt>or</tt> of one {@link Register} and the value of another one.
 *
 * Can be expressed as:
 * <code>op1 = op1 | op2;</code>
 */
public class OrStatement extends AbstractBinaryMathStatement {
    public OrStatement(PrimitiveType type, Register op1, Register op2) {
        super(type, op1, op2);
    }
